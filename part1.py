...
class Game():
    ...
    def whenAnArrowKeyIsPressed(self, e) -> None:
        ...
        if (currentDirection == "Left" and e.keysym == "Right" or 
            ...
            #These are invalid actions --> return None to end the function
            return None
    ...
    def move(self) -> None:
        ...
        if self.snakeCoordinates[-1] == self.prey:
            ...
            self.createNewPrey
        else: #Remove the last tile of the snake
    ...
    def createNewPrey(self) -> None:
        ...
        # Make sure the prey does not spawn on top of the snake
        while (prey_x, prey_y) in self.snakeCoordinates:
            prey_x = random.randint(THRESHOLD, WINDOW_WIDTH - THRESHOLD)
            prey_y = random.randint(THRESHOLD, WINDOW_HEIGHT - THRESHOLD)

        self.prey = (prey_x, prey_y)
        prey_coords = (prey_x - 5, prey_y - 5, prey_x + 5, prey_y + 5)
